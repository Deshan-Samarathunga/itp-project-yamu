...
$sql = "SELECT c.*, b.booking_No, v.vehicle_title, u.full_name AS complainant_name
        ...
        WHERE c.complaint_id = {$complaintId}
          AND (c.target_user_id = {$driverId} OR owned_vehicle.owner_user_id = {$driverId})
        LIMIT 1";
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="profile-details card">
                ...
                <div class="form-group"><label>Status</label><input type="text" value="<?php echo carzo_e(ucfirst(str_replace('_', ' ', $complaint['status']))); ?>" readonly></div>
                <form action="includes/driver-dispute-process.php" method="POST" class="signup-form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="driver_response" id="driver_response" rows="6"><?php echo carzo_e($complaint['driver_response']); ?></textarea>
                    </div>
