...
-- Sources: db/yamu.sql, db/migrations/phase2_user_roles_profile.sql, db/migrations/phase3_vehicle_booking_management.sql,
-- db/migrations/phase4_reviews_payments_promotions.sql, db/migrations/phase5_staff_role.sql, db/migrations/phase6_driver_ads.sql,
-- db/migrations/phase6_user_profile_role_management.sql, db/migrations/phase8_provider_role_portal_cleanup.sql
...
(1, 'BOOK88523', 3, 6, 3, '2023-06-06', '2023-06-08', 13000, 1, 'confirmed', 'pending', NULL, NULL, 0.00, 13000.00, '2023-06-06 23:13:43', '2023-06-06 23:13:43', '2023-06-06 23:13:43', NULL, NULL, NULL),
(3, 'BOOK44665', 3, 6, 4, '2023-06-07', '2023-06-08', 9500, 0, 'pending', 'pending', NULL, NULL, 0.00, 9500.00, '2023-06-07 23:17:44', '2023-06-07 23:17:44', '2023-06-07 23:17:44', NULL, NULL, NULL);
...
(6, 'sample.staff@yamu.com', '827ccb0eea8a706c4c34a16891f84e7b', 'staff', 'Yamu Rental Center', 'sample.staff@yamu.com', '155 Galle Road, Colombo 03', 'Colombo', '0775550100', '', NULL, 'verified', 'Sample seeded rental center account for vehicle listings.', 'avatar.png', 'active', '2023-06-11 12:45:00', '2023-06-11 12:45:00', '2023-06-11 12:45:00');
...
-- --------------------------------------------------------
-- Integrated from db/migrations/phase6_user_profile_role_management.sql
-- Includes the latest provider-profile cleanup from db/migrations/phase8_provider_role_portal_cleanup.sql
-- --------------------------------------------------------
...
SET
  `store_name` = 'Yamu Rental Center',
  `store_owner` = 'Yamu Rental Center',
  `business_registration_number` = 'YAMU-STF-001',
  `store_address` = '155 Galle Road, Colombo 03',
  `store_contact_number` = '0775550100',
  `store_email` = 'sample.staff@yamu.com',
