...
$page_title = 'Edit Vehicle Listing';
...
<body>
    ...
    <section class="profile">
        ...
        <div class="container">
            <div class="row">
                <?php
                $currentAccountPage = 'staff-vehicles';
                include 'includes/account-sidebar.php';
                ?>
                <div class="profile-details card">
                    <form action="includes/staff-vehicle-process.php" method="POST" enctype="multipart/form-data" class="signup-form">
                        <h3>Edit Vehicle Listing</h3>
                        <input type="hidden" name="vehicleId" value="<?php echo (int) $vehicle['vehicle_id']; ?>" />
                        <div class="form-group">
                            <label for="vehicleTitle">Vehicle Title:</label>
                            <input type="text" name="vehicleTitle" id="vehicleTitle" value="<?php echo yamu_e($vehicle['vehicle_title']); ?>" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="vehicleDesc" id="vehicleDesc" rows="5"><?php echo yamu_e($vehicle['vehicle_desc']); ?></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="modelYear" id="modelYear" value="<?php echo yamu_e($vehicle['year']); ?>" required />
                        </div>
                        <div class="form-group">
                            <label for="engineCap">Engine Capacity (CC):</label>
                            <input type="number" name="engineCap" id="engineCap" value="<?php echo yamu_e($vehicle['engine_capacity']); ?>" required />
                        </div>
                        <div class="form-group">
                            <label for="capacity">Seat Capacity:</label>
                            <input type="number" name="capacity" id="capacity" value="<?php echo yamu_e($vehicle['capacity']); ?>" required />
                        </div>
                        <div class="form-group">
                            <label for="price">Daily Price:</label>
                            <input type="number" step="0.01" name="price" id="price" value="<?php echo yamu_e($vehicle['price']); ?>" required />
                        </div>
                        <div class="form-group">
                            <label for="listing_status_display">Listing Status:</label>
                            <input type="text" id="listing_status_display" value="<?php echo yamu_e(ucfirst($vehicle['listing_status'])); ?>" readonly />
                        </div>
                        <div class="form-group">
                        ...
                        <input type="submit" value="Update Listing" class="btn main-btn" name="updateStaffVehicle" />
                    </form>
                </div>
            </div>
        </div>
