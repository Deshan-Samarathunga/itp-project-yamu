            ...
            <table>
              ...
              <tbody>{bookings.map(b => (
                <tr key={b._id}>
                  ...
                  <td><span className={`badge ${b.bookingStatus==='completed'?'badge-success':b.bookingStatus==='confirmed'?'badge-info':b.bookingStatus==='cancelled'?'badge-danger':'badge-warning'}`}>{b.bookingStatus}</span></td>
                  <td>
                    {b.bookingStatus === 'pending' && <>
                      <button className="btn btn-primary btn-sm" onClick={() => updateStatus(b._id, 'confirmed')} style={{ marginRight: 4 }}>Confirm</button>
