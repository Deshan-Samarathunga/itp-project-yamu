...
export default function PaymentHistory() {
  ...
  useEffect(() => { API.get('/payments/my').then(r => setPayments(r.data)).catch(() => {}).finally(() => setLoading(false)); }, []);

  return (
    <div className="dashboard-layout">
      <Sidebar />
      <main className="dashboard-content">
        <div className="form-header"><h2>Payment History</h2></div>
        {loading ? <div className="spinner-container"><div className="spinner"></div></div> : payments.length > 0 ? (
          <div className="table-container">
            <table>
              <thead><tr><th>Booking</th><th>Amount</th><th>Method</th><th>Status</th><th>Date</th></tr></thead>
